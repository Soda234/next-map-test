  ...
  <>
    <div className="navbar">
        ...
        <div className="navbar_list">
            <Link href="/stroes" className="navbar_list-item">맛집 목록</Link>
            <Link  href="/stroes/new" className="navbar_list-item">맛집 등록</Link>
            <Link href="/users/likes" className="navbar_list-item">찜한 가게</Link>
            <Link href="/users/login" className="navbar_list-item">로그인</Link>
        </div>
        {/* mobile button */}
        <div role="presentation" className="navbar_button" onClick={() => setIsOpen(!isOpen)}>
...
{isOpen && (
    <div className="navbar-mobile">
     <div className="navbar_list-mobile">
            <Link href="/stroes" className="navbar_list-item-mobile">맛집 목록</Link>
            <Link  href="/stroes/new" className="navbar_list-item-mobile">맛집 등록</Link>
